            ...
            <div className="grid grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        ${errors.firstName ? 'border-[#ED4545] border-2' : 'border-[#CBB6E5] border'} 
                        focus:border-[#761BE4] focus:border-2 focus:ring-0 sm:text-sm`}
                    />
                    {errors.firstName && (
                        <p className="text-red-500 text-sm flex items-center">
                            <ErrorIcon /> <span className="ml-1">{errors.firstName}</span>
                        </p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={onChange}
                        className={`mt-1 p-2 w-full border rounded-md shadow-sm 
                        ${errors.lastName ? 'border-[#ED4545] border-2' : 'border-[#CBB6E5] border'} 
                        focus:border-[#761BE4] focus:border-2 focus:ring-0 sm:text-sm`}
                    />
                    {errors.lastName && (
                        <p className="text-red-500 text-sm flex items-center">
                            <ErrorIcon /> <span className="ml-1">{errors.lastName}</span>
                        </p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={onChange}
                        className={`mt-1 p-2 w-full border rounded-md shadow-sm 
                        ${errors.email ? 'border-[#ED4545] border-2' : 'border-[#CBB6E5] border'} 
                        focus:border-[#761BE4] focus:border-2 focus:ring-0 sm:text-sm`}
                    />
                    {errors.email && (
                        <p className="text-red-500 text-sm flex items-center">
                            <ErrorIcon /> <span className="ml-1">{errors.email}</span>
                        </p>
                    )}
                </div>
            </div>
